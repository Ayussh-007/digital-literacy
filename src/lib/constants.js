...
export const WHEEL_SEGMENTS = [
  { label: 'Robot Walk 🤖', value: 'robot', type: 'fun', color: '#6C5CE7' },
  { label: 'Freeze for 10s', value: 'freeze', type: 'fun', color: '#00CEC9' },
  { label: 'Silly Dance 💃', value: 'dance', type: 'fun', color: '#FD79A8' },
  { label: 'Act like Statue', value: 'statue', type: 'fun', color: '#FDCB6E' },
  { label: 'Slow Mo Walk', value: 'slow_mo', type: 'fun', color: '#FF6B6B' },
  { label: 'Roar like Lion', value: 'lion', type: 'fun', color: '#E84393' },
  { label: 'Laugh out Loud', value: 'laugh', type: 'fun', color: '#00B894' },
  { label: 'Play Air Drums', value: 'drums', type: 'fun', color: '#74B9FF' },
  { label: 'Bark like Dog', value: 'bark', type: 'fun', color: '#A29BFE' },
  { label: 'ABC Backwards', value: 'abc', type: 'fun', color: '#FF7675' },
  { label: 'Count 1-10 Fast', value: 'count', type: 'fun', color: '#FDCB6E' },
  { label: 'Funny Face 😜', value: 'funny_face', type: 'fun', color: '#6C5CE7' },
  { label: 'Act like a Tree', value: 'tree', type: 'fun', color: '#F9CA24' },
  { label: 'Giant Steps x3', value: 'giant_steps', type: 'fun', color: '#00CEC9' },
  { label: 'Pretend to Fly', value: 'fly', type: 'fun', color: '#74B9FF' },
  { label: 'Waddle as Duck', value: 'duck', type: 'fun', color: '#636E72' },
  { label: 'Swim in Air', value: 'swim', type: 'fun', color: '#FD79A8' },
  { label: 'Clap 10 Times', value: 'clap', type: 'fun', color: '#A29BFE' },
];
